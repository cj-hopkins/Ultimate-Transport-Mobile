...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactWeather = function (_React$Component) {
	  ...
	  function ReactWeather(props) {
	    ...
	    _this.api = new _XuApi2['default'](props.unit, props.apikey, props.lang);
	    _this.state = {
	      data: null
	    };
	    return _this;
	      ...
	      function render() {
	        ...
	        if (data) {
	          ...
	          return _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(_DaysForecast2['default'], { unit: unit, forecast: forecast, daysData: days, lang: lang })
	          );
	        }
	        return _react2['default'].createElement(
	          'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var XuApi = function () {
	  function XuApi(unit, apiKey, lang) {
	    ...
	    value: function () {
	      function _map(data, lang) {
	        ...
	        mapped.days = daysData.map(function (item) {
	          return {
	            date: _utils2['default'].formatDate(item.date, lang),
	  ...
	  formatDate: function () {
	    function formatDate(dte, lang) {
	      if (dte && (0, _moment2['default'])(dte).isValid()) {
	        ...
	        return (0, _moment2['default'])(dte).format('ddd D MMMM');
	      }
	      return '';
	    }
