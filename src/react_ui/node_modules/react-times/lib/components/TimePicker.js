...
var DialPlates = {
  material: (0, _AsyncComponent2.default)(function () {
    return System.import('./MaterialTheme').then(function (component) {
      return component.default;
    });
  }),
  classic: (0, _AsyncComponent2.default)(function () {
    return System.import('./ClassicTheme').then(function (component) {
      return component.default;
    });
  })
};
...
var TimePicker = function (_React$PureComponent) {
  ...
  _createClass(TimePicker, [{
    ...
    value: function render() {
      ...
      var pickerPreviewClass = (0, _classnames2.default)('time_picker_preview', focused && 'active');
